...
def home(request):
    return render(request, 'rajarancho/index.html')
        ...
        if form.is_valid():
            try:
                ...
                try:
                    ...
                    return render(request, 'rajarancho/encrypted.html', {'result': y})
                except:
                ...
                return redirect('/encrypt')
    return render(request, 'rajarancho/encrypt.html', {'form': form})
def decrypt(request):
    form = DecryptForm()
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect('/decrypt')
    return render(request, 'rajarancho/decrypt.html', {'form': form})

def encrypted(request):
    return render(request, 'rajarancho/encrypted.html')

def decrypted(request):
    return render(request, 'rajarancho/decrypted.html')
